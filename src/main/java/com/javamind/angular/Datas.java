    ...
    public static List<Conference> conferences =
            Lists.newArrayList(
                new Conference()
                        ...
                        .setPlace("Lyon")
                        .setCountry("France")
                        .setStartdate(Date.from(LocalDateTime.of(2014, Month.APRIL, 29, 8, 0, 0).toInstant(ZoneOffset.ofHours(2))))
                        .setEnddate(Date.from(LocalDateTime.of(2014, Month.APRIL, 29, 18, 0, 0).toInstant(ZoneOffset.ofHours(2))))
                        .setAttendees(500L)
                        .setPrice(50L)
                ...
                new Conference()
                        ...
                        .setPlace("Paris")
                        .setCountry("France")
                        .setStartdate(Date.from(LocalDateTime.of(2014, Month.MARCH, 16, 9, 0, 0).toInstant(ZoneOffset.ofHours(2))))
                        .setEnddate(Date.from(LocalDateTime.of(2014, Month.MARCH, 18, 18, 0, 0).toInstant(ZoneOffset.ofHours(2))))
                        .setAttendees(1500L)
                        .setPrice(650L)
                ...
                new Conference()
                        ...
                        .setPlace("Lyon")
                        .setCountry("France")
                        .setStartdate(Date.from(LocalDateTime.of(2014, Month.OCTOBER, 29, 9, 0, 0).toInstant(ZoneOffset.ofHours(2))))
                        .setEnddate(Date.from(LocalDateTime.of(2014, Month.OCTOBER, 30, 18, 0, 0).toInstant(ZoneOffset.ofHours(2))))
                        .setAttendees(500L)
                        .setPrice(239L)
                ...
                new Conference()
                        ...
                        .setCountry("France")
                        .setStartdate(Date.from(LocalDateTime.of(2014, Month.SEPTEMBER, 18, 9, 0, 0).toInstant(ZoneOffset.ofHours(2))))
                        .setEnddate(Date.from(LocalDateTime.of(2014, Month.SEPTEMBER, 18, 18, 0, 0).toInstant(ZoneOffset.ofHours(2))))
                        .setAttendees(170L)
                        .setPrice(0L)
